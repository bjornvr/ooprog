...
.org	0x000
main:
		ldi		r16,allin			; Configureer poort 
		out		dirswitches,r16		; voor drukknoppen

		ldi		r18,allout			; Configureer poort		 
		out		dirleds,r18			; voor lampen
									

start:	ldi		r16,veh_g_ped_r		; Auto's groen en
...
readswitches:
		...
		ldi		delay1,0xd5			; Wacht 5 seconden 0xD5DC3200
		ldi		delay2,0xdc
		ldi		delay3,0x32
		ldi		delay4,0x00
...
wait5:	subi	delay1,1
		...
		ldi		delay1,0x08			; Wacht 10 seconden
		ldi		delay2,0x5A			; TODO: werkt nog niet
		ldi		delay3,0x99
		ldi		delay4,0xF4
		ldi		delay5,0x00
